...
------------------------------------------------------------------------------------------------------------------------
    ...
    local t = mainFrame_current:CreateTexture(nil, "OVERLAY")
    t:SetTexture(nil)
    ...
    t = mainFrame_next:CreateTexture(nil, "OVERLAY")
    t:SetTexture(nil)
    ...
    t = mainFrame_bear:CreateTexture(nil, "OVERLAY")
    t:SetTexture(nil)
    ...
    t = mainFrame_cat:CreateTexture(nil, "OVERLAY")
    t:SetTexture(nil)
    ...
    t = mainFrame_berserk:CreateTexture(nil, "OVERLAY")
    t:SetTexture(nil)
